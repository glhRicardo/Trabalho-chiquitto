...
<div id="cadatrar">
<form id="cadastro" name="cadastro" method="post" action="cadastrar-cliente-salvar.php" onSubmit="return validaCampo(); return false;">
  <table width="625" border="0">
    <tr>
      <td width="69">Nome:</td>
      <td width="546"><input name="nome" type="text" id="nome" size="60" maxlength="50" />
        <span class="style4">*</span></td>
    </tr>
    <tr>
      <td>Email:</td>
      <td><input name="email" type="text" id="email" size="60" maxlength="50" />
      <span class="style4">*</span></td>
    </tr>
    <tr>
      <td>Sexo:</td>
	...
	<tr>
     ...
     <tr>
       <td>CPF:</td>
       <td>  <input name="cpf" type="text" id="cpf" maxlength="11" onblur="valida()" /> 
       <span class="style3">Apenas numeros</span><span class="style4">*</span> </td>
    </tr>
    <tr>
       <td>Telefone:</td>
       <td><input name="telefone" type="text" id="telefone" />
        <span class="style3">Apenas numeros com DDD</span><span class="style4">*</span> </td>
    </tr>
    <tr>
      <td>Endereço:</td>
      <td><input name="endereco" type="text" id="endereco" size="60" maxlength="50" />
        <span class="style4">*</span></td>
    </tr>
    <tr>
      <td>Cidade:</td>
    ...
    <tr>
      <td>CEP:</td>
      <form name="Formulario Validacao" action="CadastroCliente.php">
    ...
    <tr>
    	<td>Login:</td>
        <td><input name = "login" type="text" id="login" maxlength="14" />
   		<span class="style4">*</span></td>
   	</tr>
      ...
      <td colspan="2"><p>
		...
		<?php
         if( isset($_SESSION['logado']) ){?>
					 <a href="editar-usario.php">Editar Usuario</a>
                     <a href="excluir-usuario.php">Excluir conta</a>  
                <?php
				}
				?>		
        <p><span class="style1">Campos com <span class="style4"> * </span> são obrigatórios! </span></p>
